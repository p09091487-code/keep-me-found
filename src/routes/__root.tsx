...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Enregistrez l'IMEI de vos appareils, activez le traçage en cas de perte ou de vol et recevez des alertes en temps réel sur une carte interactive." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "PhoneTrack — Traçage IMEI et sécurité mobile" },
      { name: "twitter:description", content: "Enregistrez l'IMEI de vos appareils, activez le traçage en cas de perte ou de vol et recevez des alertes en temps réel sur une carte interactive." },
