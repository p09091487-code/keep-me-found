...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "PhoneTrack" },
      ...
      { property: "og:image:alt", content: "Aperçu de PhoneTrack — traçage IMEI et carte temps réel" },
      ...
      { name: "twitter:image:alt", content: "Aperçu de PhoneTrack — traçage IMEI et carte temps réel" },
    ],
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02fb1779-b530-484f-a994-080df43a6fd2/id-preview-7d6d536f--07d966f3-5640-4300-a526-678a6d13d724.lovable.app-1781615396973.png",
